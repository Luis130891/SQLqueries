...
host cls
PROMPT ====================================================================
PROMPT Crea una estructura igual en usuario hr2
conn system/admin
...
PROMPT HR.LOCATIONS table has a foreign key to this table.
...
PROMPT OE.CUSTOMERS table and HR.LOCATIONS have a foreign key to this table.
...
PROMPT HR.DEPARTMENTS has a foreign key to this table.
...
PROMPT HR.EMPLOYEES and HR.JOB_HISTORY have a foreign key to this table.
...
PROMPT HR.EMPLOYEES has a foreign key to this table.
...
PROMPT HR.EMPLOYEES has a self referencing foreign key to this table.
...
PROMPT HR.JOBS, HR_DEPARTMENTS, and HR.EMPLOYEES have a foreign key to this table.
...
PROMPT ==============================================
PROMPT #1 Cantidad de Objetos por Tipo
set linesize 200
set pagesize 200

select owner, object_type, count(*) CANT
from   DBA_OBJECTS
where  owner = 'HR2'
...
PROMPT ==============================================
PROMPT #2 Cantidad de Registros por Tabla
select  'JOBS' tabla, count(*) CANT
from hr2.JOBS
union
select  'JOB_HISTORY' tabla, count(*) cantidad
from hr2.JOB_HISTORY
union
select  'EMPLOYEES'   tabla, count(*) cantidad
from hr2.EMPLOYEES
union
select  'DEPARTMENTS' tabla, count(*) cantidad
from hr2.DEPARTMENTS
union
select  'LOCATIONS'   tabla, count(*) cantidad
from hr2.LOCATIONS
union
select  'COUNTRIES'   tabla, count(*) cantidad
from hr2.COUNTRIES
union
select  'REGIONS'     tabla, count(*) cantidad
from hr2.REGIONS 
order by 1;
PROMPT Fin==============================================
